...
string CommandLine::quoteIfNecessary(string toQuote)
{
	if(toQuote.find(" ") != string::npos)
	{
		toQuote = '\"' + toQuote + '\"';
	}
...
std::string CommandLine::getCommandlineString()
{
...
int CommandLine::executeAndWait(int sin, int sout, int serr)
{
#ifdef WIN32
