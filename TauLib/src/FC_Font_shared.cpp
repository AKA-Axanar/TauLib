...
//
// FC_Font_Shared from a FC_Font*. The last shared_ptr destroyed closes the font.
// 
...
//
// FC_Font_Shared from a font file. The last shared_ptr destroyed closes the font.
// 
